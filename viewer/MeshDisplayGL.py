# Visualize a mesh using VisPy (wrapping openGL)
...
from ..core.HalfEdgeMesh import HalfEdgeMesh
from ..core.TriSoupMesh import TriSoupMesh
from ..core.Utilities import normalize, norm, cross
...
class MeshDisplayGL(object):
    ...
    def __init__(self, windowTitle='Cyamites MeshDisplay', mesh=None,
        ...
        self.vectorMethod = 'none'  # other possbilities: 'directionData', 'vectorData' (TODO)
    ...
    def prepareSurfVecProgram(self):
        ...
        self.surfVecProg.createVBO(
            vboName = 'vertColor', varName = 'a_color', vaoName = 'meshVAO', nPerVert = 3)
        # VBO for array indices TODO try without an index buffer
        # self.surfVecProg.createIndexBuffer(vboName = 'edgeIndex',  vaoName = 'meshVAO')
    ...
    def setSurfaceDirections(self, vectorAttrName, vectorRefDirAttrName='refDirR3', nSym=1):
    ...
    def generateColor(self, triSoupMesh):
        ...
        # Assign colors from a scalar defined over the surface using a colormap
            ...
            print("Coloring with scalar data field: [" + str(self.colorAttrName) + "]\n        range is " + str(vMinMax[0]) + "  ---  " + str(vMinMax[1]))
